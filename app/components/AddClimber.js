                ...
                <form onSubmit={this.handleSubmit.bind(this)}>
                  ...
                  <div className={'form-group ' + this.state.styleValidationState}>
                    <div className='radio radio-inline'>
                      <input type='radio' name='style' id='sport' value='Sport' checked={this.state.gender === 'Sport'}
                        onChange={AddClimberActions.updateStyle} />
                      <label htmlFor='sport'>Sport</label>
                    </div>
                    <div className='radio radio-inline'>
                      <input type='radio' name='style' id='boulder' value='Boulder' checked={this.state.gender === 'Boulder'}
                             onChange={AddClimberActions.updateStyle} />
                      <label htmlFor='boulder'>Boulder</label>
                    </div>
                    <div className='radio radio-inline'>
                      <input type='radio' name='style' id='trad' value='Trad' checked={this.state.gender === 'Trad'}
                             onChange={AddClimberActions.updateStyle} />
